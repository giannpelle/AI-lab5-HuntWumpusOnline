...
class KnowledgeBase(object):
    ...
    def get_bayesian_model(self):
        ...
        pit_cpds_dict = {}
        pit_cpds_dict.update(self.make_bayesian_bool_propositions_dict(for_locations=self.fringe_locations.difference(self.no_pit_locations),
                                                                                                                    with_name_prefix='P', 
    ...
    def get_next_action_from(self, *, percept):
        ...
        if not self.plan_actions:
            ...
            if self.kb.is_arrow_available and self.kb.possible_wumpus_locations:
                for fringe_location in self.kb.fringe_locations.difference(self.kb.no_pit_locations):
